...
(function ($) {
    ...
    $.fn.fileinput.locales.es = {
        ...
        cancelTitle: 'Cancelar subir el archivo en curso',
        uploadLabel: 'Cargar Archivo',
        uploadTitle: 'Cargar archivos seleccionados',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño máximo permitido de <b>{maxSize} KB</b>. Por favor reintente subirlo!',
        msgFilesTooLess: 'Usted debe seleccionar al menos <b>{n}</b> {files} a cargar. Por favor reintente su cargue!',
        msgFilesTooMany: 'El número de archivos seleccionados a cargar <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>. Por favor reintente subirlos!',
